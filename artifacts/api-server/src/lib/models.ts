...
export const MODEL_CATALOG: ModelDef[] = [
  ...
  { id: "claude-opus-4-8", label: "Claude Opus 4.8", provider: "anthropic", providerModel: "claude-opus-4-8" },
  { id: "claude-opus-4-7", label: "Claude Opus 4.7", provider: "anthropic", providerModel: "claude-opus-4-7" },
  { id: "claude-haiku-4-5", label: "Claude Haiku 4.5", provider: "anthropic", providerModel: "claude-haiku-4-5-20251001" },
